...
export function setLanguage(lang) {
  const sections = [...document.querySelectorAll('.hero,.chapter-map,.lesson-section,.final-exhibition')];
  ...
  document.title = text('VISUAL ATLAS · 网页页面布局', 'VISUAL ATLAS · Web Page Layout');
